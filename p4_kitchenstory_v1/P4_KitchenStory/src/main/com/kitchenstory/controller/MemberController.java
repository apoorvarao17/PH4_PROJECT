...
public class MemberController {
	...
	private UserService userService; 
	  ...
	  @RequestMapping(value = "/login", method = RequestMethod.GET)
	    ...
	    {
		  map.addAttribute("pageTitle", "KITCHEN STORY - MEMBER LOGIN");
	        return "login"; 
	    }	
	  ...
	  @RequestMapping(value = "/signup", method = RequestMethod.GET)
	    ...
	    {
		  map.addAttribute("pageTitle", "KITCHEN STORY - MEMBER REGISTRATION");
	        return "register"; 
	    }	
	  ...
	  @RequestMapping(value = "/editprofile", method = RequestMethod.GET)
	    public String editProfile(ModelMap map, javax.servlet.http.HttpServletRequest request) 
	    {
		  ...
		  map.addAttribute("pageTitle", "Kitchen Story - MEMBER EDIT PROFILE");
